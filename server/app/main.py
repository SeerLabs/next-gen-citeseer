...
import os
from routers import document_routes, elastic_routes, authentication_routes, redirect_routes, search_routes
...
app.include_router(redirect_routes.router, tags=["search_routes"], prefix="/search")
