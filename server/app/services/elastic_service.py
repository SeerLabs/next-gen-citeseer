...
class ElasticService:
    def __init__(self):
        ...
        self.connection = Elasticsearch([{"host": "csxesm03.ist.psu.edu", "port":9200}]) 
    ...
    def test_connection(self):
        ...
        req = requests.get("http://csxesm03.ist.psu.edu:9200")
        content = req.content
    ...
    def paginated_search(
        self, index, query, page, pageSize, fields_to_search, source=None
    ):
